...
if ($_GET['del']==1) {
    mysql_query('Delete from marks;');mysql_query('Update skaters Set npenalty=NULL,ttime=NULL,ttimeb=NULL;');
} else {
    if ($_GET['deli']){
        mysql_query('Delete from marks where nskater='.$_GET['deli']);
        mysql_query('Update skaters Set npenalty=NULL,ttime=NULL,ttimeb=NULL where id='.$_GET['deli']);
    } 
